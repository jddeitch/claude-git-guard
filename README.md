...
Derived from a hook that's been in production for nine months inside a personal AI system. See [the accompanying essay](https://jddeitch.substack.com/) for the backstory (link goes live with the repo).
